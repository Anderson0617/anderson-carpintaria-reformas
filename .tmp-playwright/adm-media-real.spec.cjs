...
const uploadFile = path.resolve('/mnt/c/Users/Admin/Desktop/Anderson-Carpintaria-Reformas/assets/CAPA-TOPO-73.jpeg');

test('real ADM media upload flow', async ({ browser }) => {
  const logs = [];
  const requests = [];
  const responses = [];
